...
class KojtoOptimizer2drPackages(models.Model):
    ...
    @api.onchange("stock_rectangles_ids", "cutted_rectangles_ids", "optimization_method", "width_of_cut", "use_stock_priority", "margin_left", "margin_right", "margin_top", "margin_bottom")
